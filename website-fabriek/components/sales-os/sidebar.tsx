...
export function SalesSidebar({ collapsed, onToggleCollapse, onOpenSearch }: SalesSidebarProps) {
  ...
  return (
    <aside
      className={cn(
        "sales-os-sidebar fixed left-0 top-0 z-40 flex h-screen shrink-0 flex-col border-r border-neutral-200 bg-[#fafafa] text-neutral-800 transition-[width] duration-200 ease-out dark:border-zinc-700/80 dark:bg-zinc-950 dark:text-zinc-200",
        w,
      )}
    >
      <div className="flex h-14 items-center gap-2 border-b border-neutral-200 px-3 dark:border-zinc-700/80">
        {!collapsed ? (
          <Link
            href="/admin/ops"
      ...
      <div className="border-b border-neutral-200 px-3 py-2 dark:border-zinc-700/80">
        ...
        >
          ...
          {!collapsed ? <span className="truncate">Zoeken…</span> : null}
        </button>
      </div>
      ...
      <div className="border-t border-neutral-200 px-3 py-2 dark:border-zinc-700/80">
        <Link
