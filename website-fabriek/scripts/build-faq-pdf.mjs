/**
 * Bouwt public/docs/veelgestelde-vragen-website-fabriek.pdf uit lib/admin/user-faq-nl.json.
...
const outPath = join(outDir, "veelgestelde-vragen-website-fabriek.pdf");
...
async function main() {
  ...
  const subtitle = "Website Fabriek — in gewone taal";
  page.drawText(title, {
    x: margin,
    y,
    size: 20,
