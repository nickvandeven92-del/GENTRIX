...
- **Hero-idee (VERPLICHT visuele diepte):** **geen** kale zwarte of grijze vlakken. Voorkeur: **full-bleed Unsplash** (\`style="background-image:url(https://images.unsplash.com/photo-…?w=1920&q=80)"\` + \`bg-cover bg-center\`) — abstract digitaal, werkplek met schermen, bokeh, filmset, camera, stad bij nacht — passend bij multimedia/tech. **Of** werkende stille video (Pexels) met poster. **Subtiele variant** (rustig, niet druk): mag — zolang er **gelaagde gradient + textuur/decor** is (geen effen \`bg-black\`); foto hoeft niet altijd dominant.
