...
export function normalizeAdminDashboardTheme(_value: string | null): AdminDashboardTheme {
  return ADMIN_DASHBOARD_THEME_DEFAULT;
}

/** Zet altijd licht admin-thema op <html>; geen `dark`-class. */
export function applyAdminDashboardThemeToDocument(_theme?: AdminDashboardTheme): void {
