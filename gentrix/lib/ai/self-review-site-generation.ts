...
- **Lege mediakolom:** grote kale/zwarte placeholder naast copy → vul met \`background-image\`/gradient met textuur, typografie-led, of **klantfoto-URL** — **geen** Unsplash buiten \`id: "gallery"\`; of verwijder het split-patroon ten gunste van enkelkolom — **geen** lege decoratieve rechterkolom.
