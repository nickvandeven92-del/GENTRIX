...
- **Dubbele reviews-secties / dubbele randen in grids:** als twee landingssecties beide een groot “wat klanten zeggen”-raster of vergelijkbare social-proof-grid tonen, **snoei** tot **één** sectie (behoud \`id\`’s en volgorde: herschrijf de zwakkere sectie naar ander onderwerp of korte teaser + link). Als review- of USP-kaarten in een grid elk volledige \`border\` hebben waardoor **dubbele** lijnen op naden ontstaan, herschrijf naar \`divide-x divide-y\`, enkelzijdige randen (\`border-r border-b\` + \`last:\`), of één wrapper-rand — **zonder** sectie-\`id\`’s te wijzigen.
