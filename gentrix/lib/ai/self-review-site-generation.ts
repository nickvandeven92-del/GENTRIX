...
- **Lege mediakolom:** grote kale/zwarte placeholder naast copy → vul met relevante Unsplash, \`background-image\`/gradient met textuur, of verwijder het split-patroon ten gunste van enkelkolom — **geen** lege decoratieve rechterkolom.
