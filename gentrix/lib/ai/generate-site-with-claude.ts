...
- **Reviews-slot contract (voor live data in unieke layout):** als je een testimonials-/reviews-blok maakt, zet de buitenste container op \`data-gx-reviews="slot"\` (optioneel \`data-gx-max-reviews="4"\`), markeer precies één kaart als \`data-gx-review-template\`, en geef velden waar mogelijk \`data-gx-review-author\`, \`data-gx-review-text\`, \`data-gx-review-date\`, \`data-gx-review-platform\` (rating optioneel: \`data-gx-review-rating="text"\` of \`data-gx-review-stars\`). **Behoud je eigen design** (borders/spacing/kleuren); deze markers zijn alleen voor inhoudsvervanging.
