...
- **Holistische sfeer:** vraagt de gebruiker om een **bredere** wijziging (bijv. “hele pagina”, “alles dezelfde stijl”, “niet alleen de navbar”, “doorvoeren overal”): werk dan **alle relevante** secties bij binnen de toegestane scope (hero, body-secties die visueel mee moeten, footer indien nodig) ??? niet alleen de eerste plek waar je verschil ziet. Blijft de scope bewust één sectie (bv. “alleen footer”): dan respecteer je dat en wijzig je niet stiekem de rest.
