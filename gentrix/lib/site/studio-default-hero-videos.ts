...
- **“Dynamisch”, “levendig”, “animatie”, “bewegende hero” of “subtiele beweging” zonder videobestand-URL:** gebruik **geen** stock-\`<video>\` — werk met Unsplash / gradient / split-layout, Tailwind-transities, en studio-markeringen (\`data-animation\`, \`data-aos\`, \`studio-border-reveal\`, …) zoals elders in deze prompt.
