...
export function buildStudioAutoMobileNavHeaderHtml(
  ...
  <div id="gentrix-site-mobile-sheet" class="fixed inset-x-0 top-16 z-[70] overflow-hidden border-b border-white/10 bg-slate-950 shadow-[0_24px_40px_-24px_rgba(0,0,0,0.55)] ring-1 ring-white/10 lg:hidden will-change-transform" x-show="navOpen" x-cloak
