...
### Supabase
Plak elk bestand **in volgorde** in de SQL Editor van het project waar je deze stack wilt draaien en voer uit.

Let op: `supabase db push` vanaf de **GENTRIX-root** (`gentrix/supabase/migrations/`) voert **niet** automatisch deze bestanden uit — ze staan bewust naast deze Vite-app.
